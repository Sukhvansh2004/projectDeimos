...
namespace gazebo {
#define DEPTH_CAMERA_NAME "real_depth"
#define COLOR_CAMERA_NAME "real_color"
#define IRED1_CAMERA_NAME "real_infrared1"
#define IRED2_CAMERA_NAME "real_infrared2"
